    ...
    <section id="styles" className="relative py-28 px-6 max-w-7xl mx-auto">
      <div className="flex items-end justify-between flex-wrap gap-6 mb-14">
        ...
        <p className="text-muted-foreground max-w-sm">
          From solo soul-searches to girls-only road trips — pick the vibe, we'll handle the rest.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {styles.map((s, i) => (
          <motion.button
            ...
            whileHover={{ y: -6 }}
            className="group relative overflow-hidden rounded-2xl bg-card border border-border p-5 text-left shadow-card hover:shadow-glow transition-shadow"
          >
